...
export class HomonymaService {
  ...
  postData(lexeme: string, graminfo: string, strict: string) {
    const body = {"lexeme": lexeme, "graminfo": graminfo, strict};
    console.log(body);
    let r = this.http.post<{}>('http://127.0.0.1:5000/homonyma', body);
    console.log(r);
    return r;
  }

...
export class GroupService {
  ...
  postData(lexeme: string, graminfo: string, group: string, similarity: string) {
    const body = {"lexeme": lexeme, "graminfo": graminfo, "group": group, "similarity": similarity};
    console.log(body);
    let r = this.http.post<{}>('http://127.0.0.1:5000/gensim_group', body);
    console.log(r);
    return r;
  }
